...
//   const [cartCount, setCartCount] = useState(0);
  ...
  return (
    <nav className='relative '>
      ...
      {/* medium nav for logo, searchbar, and other icons */}
      <div className='bottom-bar py-10 bg-[#15161d] text-white flex-col sm:flex-col sm:py-10 md:py-10 md:flex-col items-center justify-center lg:flex-row text-center gap-4 md:flex md:justify-between md:px-24'>
        ...
        <div className="search-bar flex text-sm justify-center items-center my-5 md:my-0">
          <form>
            <input className='py-2 sm:px-9 px-2 rounded-l-full text-black' type="text" placeholder='Search here' />
          </form>
      ...
      <div className="hidden md:flex gap-8 px-4 md:px-24 py-4 bg-white shadow-md">
        ...
        <div className="group">
          <Link to="/smartphones" className="relative hover:text-[#D10024]"> Smartphones<span className="absolute left-0 bottom-0 w-0 h-1 bg-[#D10024] transition-all top-5 duration-300 group-hover:w-full"></span></Link>
        </div>
        <div className="group">
